...
def get_video_clothes_diffrent_scene(has_figure:bool,clothesurl:str,description:str,is_down:bool=True):
...
if __name__ == '__main__':
    ...
    result_path=get_video_clothes_diffrent_scene(has_figure,clothesurl,description,is_down)