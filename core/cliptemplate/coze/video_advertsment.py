...
from core.cliptemplate.coze.transform.coze_videos_advertsment import trans_videos_advertisement




def get_video_advertisement(conpany_name,service,topic,content=None,need_change=False):
    ...
    parameters={"conpany_name":conpany_name,
                "service":service,
                "topic":topic,
                "content":content,
    ...
    result_path=trans_videos_advertisement(response)
...
if __name__ == "__main__":
    for i in range(10):
        get_video_advertisement("阳山数谷","企业园区运营","园区运营")
